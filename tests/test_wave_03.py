...
def test_mark_complete_missing_task(client):
    ...
    assert response_body == {"message": "Could not mark complete Task 1 as it was not found"}
...
def test_mark_incomplete_missing_task(client):
    ...
    assert response.status_code == 404
    assert "Task 1" in response_body["message"]
    assert response_body == {"message": "Could not mark incomplete Task 1 as it was not found"}
